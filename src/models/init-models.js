...
import _atn_tb_vagas from  "./atn_tb_vagas.js";
...
export default function initModels(sequelize) {
  const atn_tb_vagas = _atn_tb_vagas.init(sequelize, DataTypes);
  ...
  const infod_tif_acessos = _infod_tif_acessos.init(sequelize, DataTypes);
  const infod_tif_amigos = _infod_tif_amigos.init(sequelize, DataTypes);
  ...
  const infod_tif_comentario_post = _infod_tif_comentario_post.init(sequelize, DataTypes);
  const infod_tif_comunidade = _infod_tif_comunidade.init(sequelize, DataTypes);
  const infod_tif_like = _infod_tif_like.init(sequelize, DataTypes);
  const infod_tif_post = _infod_tif_post.init(sequelize, DataTypes);
